...
INSERT INTO albuns (nome, duracao, ano) VALUES
    ('Pipoco - Single',180,2022),
    ('Hear Me Now - Single',210,2016),
    ('Chromatica',200,2020),
    ('Marília Mendonça - Ao Vivo',230,2016),
    ('Renaissance',220,2022),
    ('The Colour and the Shape',250,1997),
    ('Ai Ai Ai - Single',190,2006),
    ('Luna - Single',205,2023),
    ('Flicker',210,2017),
    ('Horizonte Distante',240,2008),
    ('Blonde',260,2016),
    ('Dois',230,2016),
    ('After Hours',200,2020),
    ('OK Computer',240,1997),
    ('Scorpion',220,2018),
    ('Teu Silêncio - Single',200,2015),
    ('Slippery When Wet',250,1986),
    ('Flor e o Beija-Flor - Single',210,2016),
    ('Up All Night',230,2011),
    ('Arrival',220,1976),
    ('Toxicity',210,2001),
    ('Rumours',260,1977),
    ('(What\'s the Story) Morning Glory?',240,1995),
    ('Born to Die',230,2012),
    ('Por Supuesto - Single',200,2021),
    ('This Old Dog',420,2017),
    ('Punisher',180,2020),
    ('Os Anjos Cantam',180,2015),
    ('Rádio Pirata Ao Vivo',240,1989),
    ('Cazuza (1988)',180,1988);
