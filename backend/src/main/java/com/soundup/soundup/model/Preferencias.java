...
public class Preferencias {
    ...
    // Construtor com todos os campos (sem ID - será gerado pelo banco)
    public Preferencias(String todos_dias, String plataforma, String tipo_playlist,
                        String media_horas, String humor, String horario_dia,
                        String concentracao, String locomocao, String tipo_musica,
                        String musica_dormir, String momentos_vida, String motivacao,
                        String polemicas) {
    ...
    public Preferencias(Long id, String todos_dias, String plataforma, String tipo_playlist,
                        String media_horas, String humor, String horario_dia,
                        String concentracao, String locomocao, String tipo_musica,
                        String musica_dormir, String momentos_vida, String motivacao,
                        String polemicas) {
    ...
    public String toString() {
        return "Preferencias{" +
                ...
                ", musica_dormir='" + musica_dormir + '\'' +
                ", momentos_vida='" + momentos_vida + '\'' +
                ", motivacao='" + motivacao + '\'' +
                ", polemicas='" + polemicas + '\'' +
                '}';
    }
